...
},{"./InputStream":7,"fs":51}],4:[function(require,module,exports){
/* Copyright (c) 2012-2017 The ANTLR Project. All rights reserved.
 * Use of this file is governed by the BSD 3-clause license that
 * can be found in the LICENSE.txt file in the project root.
 */
...
},{"./InputStream":7,"fs":51}],7:[function(require,module,exports){
/* Copyright (c) 2012-2017 The ANTLR Project. All rights reserved.
 * Use of this file is governed by the BSD 3-clause license that
 * can be found in the LICENSE.txt file in the project root.
 */
...
},{"./tree/Tree":46,"./tree/Trees":47}],16:[function(require,module,exports){
/* Copyright (c) 2012-2017 The ANTLR Project. All rights reserved.
 * Use of this file is governed by the BSD 3-clause license that
 * can be found in the LICENSE.txt file in the project root.
 */
...
},{"./../PredictionContext":13,"./../Utils":17,"./../dfa/DFAState":36,"./ATNConfigSet":20}],24:[function(require,module,exports){
/* Copyright (c) 2012-2017 The ANTLR Project. All rights reserved.
 * Use of this file is governed by the BSD 3-clause license that
 * can be found in the LICENSE.txt file in the project root.
 */
...
},{"antlr4/CharStreams":3,"antlr4/CommonTokenStream":5,"antlr4/FileStream":6,"antlr4/InputStream":7,"antlr4/IntervalSet":8,"antlr4/LL1Analyzer":9,"antlr4/Lexer":10,"antlr4/Parser":11,"antlr4/ParserRuleContext":12,"antlr4/PredictionContext":13,"antlr4/Token":16,"antlr4/Utils":17,"antlr4/atn/index":33,"antlr4/dfa/index":37,"antlr4/error/index":42,"antlr4/polyfills/codepointat":44,"antlr4/polyfills/fromcodepoint":45,"antlr4/tree/index":48}],44:[function(require,module,exports){
...
},{"./../IntervalSet":8,"./../Token":16}],47:[function(require,module,exports){
/* Copyright (c) 2012-2017 The ANTLR Project. All rights reserved.
 * Use of this file is governed by the BSD 3-clause license that
 * can be found in the LICENSE.txt file in the project root.
 */
...
},{"./../Token":16,"./../Utils":17,"./Tree":46}],48:[function(require,module,exports){
/* Copyright (c) 2012-2017 The ANTLR Project. All rights reserved.
 * Use of this file is governed by the BSD 3-clause license that
 * can be found in the LICENSE.txt file in the project root.
 */
...
// Generated from cyoae.g4 by ANTLR 4.7.2
// jshint ignore: start
var antlr4 = require('antlr4/index');

// This class defines a complete listener for a parse tree produced by cyoaeParser.
function cyoaeListener() {
	antlr4.tree.ParseTreeListener.call(this);
	return this;
}

cyoaeListener.prototype = Object.create(antlr4.tree.ParseTreeListener.prototype);
cyoaeListener.prototype.constructor = cyoaeListener;

// Enter a parse tree produced by cyoaeParser#start.
cyoaeListener.prototype.enterStart = function(ctx) {
};

// Exit a parse tree produced by cyoaeParser#start.
cyoaeListener.prototype.exitStart = function(ctx) {
};


// Enter a parse tree produced by cyoaeParser#text.
cyoaeListener.prototype.enterText = function(ctx) {
};

// Exit a parse tree produced by cyoaeParser#text.
cyoaeListener.prototype.exitText = function(ctx) {
};


// Enter a parse tree produced by cyoaeParser#tag.
cyoaeListener.prototype.enterTag = function(ctx) {
};

// Exit a parse tree produced by cyoaeParser#tag.
cyoaeListener.prototype.exitTag = function(ctx) {
};


// Enter a parse tree produced by cyoaeParser#tag_name.
cyoaeListener.prototype.enterTag_name = function(ctx) {
};

// Exit a parse tree produced by cyoaeParser#tag_name.
cyoaeListener.prototype.exitTag_name = function(ctx) {
};


// Enter a parse tree produced by cyoaeParser#attribute.
cyoaeListener.prototype.enterAttribute = function(ctx) {
};

// Exit a parse tree produced by cyoaeParser#attribute.
cyoaeListener.prototype.exitAttribute = function(ctx) {
};


// Enter a parse tree produced by cyoaeParser#value.
cyoaeListener.prototype.enterValue = function(ctx) {
};

// Exit a parse tree produced by cyoaeParser#value.
cyoaeListener.prototype.exitValue = function(ctx) {
};
...
cyoaeParser.prototype = Object.create(antlr4.Parser.prototype);
cyoaeParser.prototype.constructor = cyoaeParser;

Object.defineProperty(cyoaeParser.prototype, "atn", {
	get : function() {
		return atn;
	}
});

cyoaeParser.EOF = antlr4.Token.EOF;
cyoaeParser.T__0 = 1;
cyoaeParser.T__1 = 2;
cyoaeParser.T__2 = 3;
...
function StartContext(parser, parent, invokingState) {
    ...
    this.parser = parser;
    this.ruleIndex = cyoaeParser.RULE_start;
    return this;
}
...
StartContext.prototype.tag = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
cyoaeParser.StartContext = StartContext;

cyoaeParser.prototype.start = function() {

    var localctx = new StartContext(this, this._ctx, this.state);
    this.enterRule(localctx, 0, cyoaeParser.RULE_start);
...
function TextContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = cyoaeParser.RULE_text;
    return this;
}
...
TextContext.prototype.WORD = function(i) {
    ...
    if(i===null) {
        return this.getTokens(cyoaeParser.WORD);
    } else {
        return this.getToken(cyoaeParser.WORD, i);
    }
};
...
TextContext.prototype.WS = function(i) {
    ...
    if(i===null) {
        return this.getTokens(cyoaeParser.WS);
    } else {
        return this.getToken(cyoaeParser.WS, i);
    }
};
...
cyoaeParser.TextContext = TextContext;

cyoaeParser.prototype.text = function() {
...
function TagContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = cyoaeParser.RULE_tag;
    return this;
}
...
TagContext.prototype.tag_name = function() {
...
TagContext.prototype.value = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
cyoaeParser.TagContext = TagContext;

cyoaeParser.prototype.tag = function() {

    var localctx = new TagContext(this, this._ctx, this.state);
    this.enterRule(localctx, 4, cyoaeParser.RULE_tag);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 24;
...
function Tag_nameContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = cyoaeParser.RULE_tag_name;
    return this;
}
...
Tag_nameContext.prototype.WORD = function() {
    return this.getToken(cyoaeParser.WORD, 0);
};
...
cyoaeParser.Tag_nameContext = Tag_nameContext;

cyoaeParser.prototype.tag_name = function() {
...
function AttributeContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = cyoaeParser.RULE_attribute;
    return this;
}
...
AttributeContext.prototype.WORD = function() {
    return this.getToken(cyoaeParser.WORD, 0);
};
...
cyoaeParser.AttributeContext = AttributeContext;

cyoaeParser.prototype.attribute = function() {
...
function ValueContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = cyoaeParser.RULE_value;
    return this;
}
...
cyoaeParser.ValueContext = ValueContext;

cyoaeParser.prototype.value = function() {

    var localctx = new ValueContext(this, this._ctx, this.state);
    this.enterRule(localctx, 10, cyoaeParser.RULE_value);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 59; 
...
exports.cyoaeParser = cyoaeParser;

},{"./cyoaeListener":49,"antlr4/index":43}],51:[function(require,module,exports){
